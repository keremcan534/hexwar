...
export const TERRAIN = {
  ...
  BEACH: {
    ...
    water: false, passable: true, moveCost: 1, fertility: 1, defense: 0,
  },
  DESERT: {
    id: 'DESERT', name: 'Çöl', color: '#d7b667',
    water: false, passable: true, moveCost: 1, fertility: 0, defense: 0,
  },
  PLAINS: {
    id: 'PLAINS', name: 'Ova', color: '#8fae55',
    water: false, passable: true, moveCost: 1, fertility: 3, defense: 0,
  },
  GRASSLAND: {
    id: 'GRASSLAND', name: 'Çayır', color: '#71a04a',
    water: false, passable: true, moveCost: 1, fertility: 4, defense: 0,
  },
  FOREST: {
    id: 'FOREST', name: 'Orman', color: '#3f7442',
    water: false, passable: true, moveCost: 2, fertility: 2, defense: 0.25,
  },
  JUNGLE: {
  ...
  HILLS: {
    ...
    water: false, passable: true, moveCost: 2, fertility: 2, defense: 0.35,
  },
  MOUNTAIN: {
    id: 'MOUNTAIN', name: 'Dağ', color: '#7d7268',
    water: false, passable: false, moveCost: Infinity, fertility: 0, defense: 0.6,
  },
  SNOW_PEAK: {
  ...
  ICE: {
    ...
    water: false, passable: false, moveCost: Infinity, fertility: 0, defense: 0,
  },
};
